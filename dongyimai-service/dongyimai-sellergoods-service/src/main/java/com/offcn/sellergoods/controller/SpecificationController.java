...
public class SpecificationController {
     ...
     * @return
     */
    @ApiOperation(value = "SpecEntity根据ID查询",notes = "根据ID查询SpecEntity方法详情",tags = {"SpecificationController"})
    @ApiImplicitParam(paramType = "path", name = "id", value = "主键ID", required = true, dataType = "Long")
    @GetMapping("/{id}")
    ...
    public Result<List<Map<String,Object>>> selectOptions() {
        return new Result<List<Map<String,Object>>>(specificationService.selectOptions());
    }
}
